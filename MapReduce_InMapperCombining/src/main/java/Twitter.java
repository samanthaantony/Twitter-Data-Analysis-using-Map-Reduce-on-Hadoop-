...
public class Twitter {
    ...
    public static class TwitterCombiner extends Reducer<IntWritable,IntWritable,IntWritable,IntWritable> {
        public void combiner1 ( IntWritable follower_id, Iterable<IntWritable> ids, Context context )
                           throws IOException, InterruptedException {
...

{
	...
	public static void main ( String[] args ) throws Exception {
        ...
        job.setCombinerClass(TwitterCombiner.class);
